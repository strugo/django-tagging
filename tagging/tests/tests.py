...
class TestParseTagInput(TestCase):
    def test_with_simple_space_delimited_tags(self):
        ...
        self.assertEqual(parse_tag_input('one'), [u'one'])
        self.assertEqual(parse_tag_input('one two'), [u'one', u'two'])
        self.assertEqual(parse_tag_input('one two three'), [u'one', u'three', u'two'])
        self.assertEqual(parse_tag_input('one one two two'), [u'one', u'two'])
    ...
    def test_with_comma_delimited_multiple_words(self):
        ...
        self.assertEqual(parse_tag_input(',one'), [u'one'])
        self.assertEqual(parse_tag_input(',one two'), [u'one two'])
        self.assertEqual(parse_tag_input(',one two three'), [u'one two three'])
    ...
    def test_with_no_loose_commas(self):
        ...
        self.assertEqual(parse_tag_input('one two "thr,ee"'), [u'one', u'thr,ee', u'two'])
        
    def test_with_loose_commas(self):
        """ Loose commas - split on commas """
        self.assertEqual(parse_tag_input('"one", two three'), [u'one', u'two three'])
    ...
    def test_with_naughty_input(self):
        ...
        self.assertEqual(parse_tag_input(',,,,,,'), [])
        self.assertEqual(parse_tag_input('",",",",",",","'), [u','])
        self.assertEqual(parse_tag_input('a-one "a-two" and "a-three'),
...
class TestBasicTagging(TestCase):
    ...
    def test_update_tags_exotic_characters(self):
        ...
        self.assertEqual(tags[0].name, u'ŠĐĆŽćžšđ')
        
        Tag.objects.update_tags(self.dead_parrot, u'你好')
        tags = Tag.objects.get_for_object(self.dead_parrot)
        self.assertEqual(len(tags), 1)
        self.assertEqual(tags[0].name, u'你好')
...
class TestSettings(TestCase):
    ...
    def test_force_lowercase_tags(self):
        ...
        self.assertEqual(f1.tags, u'test5')
...
class TestTagUsageForModel(TestCase):
    ...
    def test_tag_usage_for_model(self):
        ...
        self.assertTrue((u'bar', 3) in relevant_attribute_list)
        self.assertTrue((u'baz', 1) in relevant_attribute_list)
        self.assertTrue((u'foo', 2) in relevant_attribute_list)
        self.assertTrue((u'ter', 3) in relevant_attribute_list)
    ...
    def test_tag_usage_with_filter_on_model_objects(self):
        ...
        self.assertTrue((u'foo', 1) in relevant_attribute_list)
        self.assertTrue((u'ter', 1) in relevant_attribute_list)
        
        tag_usage = Tag.objects.usage_for_model(Parrot, counts=True, filters=dict(state__startswith='p'))
        relevant_attribute_list = [(tag.name, tag.count) for tag in tag_usage]
        self.assertEqual(len(relevant_attribute_list), 4)
        self.assertTrue((u'bar', 2) in relevant_attribute_list)
        self.assertTrue((u'baz', 1) in relevant_attribute_list)
        self.assertTrue((u'foo', 1) in relevant_attribute_list)
        self.assertTrue((u'ter', 1) in relevant_attribute_list)
        ...
        relevant_attribute_list = [(tag.name, tag.count) for tag in tag_usage]
        self.assertEqual(len(relevant_attribute_list), 3)
        self.assertTrue((u'bar', 1) in relevant_attribute_list)
        self.assertTrue((u'foo', 2) in relevant_attribute_list)
        self.assertTrue((u'ter', 1) in relevant_attribute_list)
        ...
        self.assertEqual(len(relevant_attribute_list), 4)
        self.assertTrue((u'bar', False) in relevant_attribute_list)
        self.assertTrue((u'baz', False) in relevant_attribute_list)
        self.assertTrue((u'foo', False) in relevant_attribute_list)
        self.assertTrue((u'ter', False) in relevant_attribute_list)
...
class TestTagsRelatedForModel(TestCase):
    ...
    def test_related_for_model_with_tag_query_sets_as_input(self):
        ...
        self.assertTrue((u'baz', 1) in relevant_attribute_list)
        self.assertTrue((u'foo', 1) in relevant_attribute_list)
        self.assertTrue((u'ter', 2) in relevant_attribute_list)
        ...
        self.assertEqual(len(relevant_attribute_list), 3)
        self.assertTrue(u'baz' in relevant_attribute_list)
        self.assertTrue(u'foo' in relevant_attribute_list)
        self.assertTrue(u'ter' in relevant_attribute_list)
